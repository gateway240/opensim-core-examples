...
int main()
{
    ...
    for (int i = startVal; i < numEl; ++i) {
        std::cout << std::fixed << std::setprecision(16) <<"Multiply: " << decimalValues[i] << " Add: " << decimalValues2[i] << std::endl;
    }
    ...
    std::cout << std::fixed << std::setprecision(24) << "Multiplication: " << err1 << " Addition: " << err2 << std::endl;
